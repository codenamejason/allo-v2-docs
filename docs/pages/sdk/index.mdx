...
The allo-v2-sdk provides functions to create and manage your profile on the registry [here](/sdk/registry).

## Pool Management

The allo-v2-sdk provides functions to create and manage your pool on the pool [here](/sdk/allo).
## Strategy Management
...
- [MicroGrants](/sdk/microgrants)
- [SuperFluidStrategy](/sdk/superfluid)

## Supported Chains

{/* add a table for suported chains */}
| Chain | ID | Supported |
|-------|----|-----------|
| Ethereum | 1 | ✅ |
| Polygon | 137 | ✅ |
